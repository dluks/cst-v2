"""
DEPRECATED: This file uses the old batch final product building approach.

The new system uses per-trait final product building with parallel processing via
stages/inference.py and src/data/build_final_product_single_trait.py.
